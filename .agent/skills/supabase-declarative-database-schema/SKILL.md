---
name: supabase-declarative-database-schema
description: Instructions for managing Supabase database schemas declaratively.
---

# Declarative Database Schema Management

Detailed instructions for managing your Supabase database schema declaratively using `.sql` files.

## When to use this skill

- Use this when modifying the database schema (tables, views, functions).
- Use this when managing database migrations in a team environment.
- Use this when setting up a new Supabase project structure.
