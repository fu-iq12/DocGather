---
name: supabase-use-realtime
description: Best practices for implementing Supabase Realtime (Broadcast, Presence, Postgres Changes).
---

# Supabase Realtime AI Assistant Guide

Detailed instructions for implementing Supabase Realtime features, including Broadcast, Presence, and Postgres Changes.

## When to use this skill

- Use this when implementing real-time features such as chat applications, live notifications, multiplayer games, or collaborative tools.
- This is helpful for choosing the right Realtime feature (Broadcast vs. Presence vs. Postgres Changes) and ensuring scalability and security.
